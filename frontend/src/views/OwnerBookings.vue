      ...
      <div class="bookings-list">
        <div v-for="booking in bookings" :key="booking.id" class="booking-card">
          ...
          <div class="booking-details">
            <p><strong>Lapangan:</strong> {{ booking.court?.name || 'Lapangan' }}</p>
            <p><strong>Tanggal:</strong> {{ formatDate(booking.booking_date) }}</p>
            <p><strong>Waktu:</strong> {{ booking.start_time }} - {{ booking.end_time }}</p>
            <p><strong>Total Harga:</strong> Rp {{ formatPrice(booking.total_price) }}</p>
          </div>
        </div>
